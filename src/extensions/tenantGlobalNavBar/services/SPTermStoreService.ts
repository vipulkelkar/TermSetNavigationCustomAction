...
export class SPTermStoreService {
    ...
    public async getTermsFromTermSetAsync(termSetName: string): Promise<ISPTermObject[]> {
        ...
        let serviceJSONResponse: Array<any> = serviceResponse.data;
